...
'set t 'tt''
'set gxout shaded'
'set clevs 0.005 0.006 0.007 0.008'
'set cmin 0.005'
'set rgb 30 140 250 250'
'set rgb 40 100 210 255'
'set ccols 0 30 40 11 4 '
'd smth9(smth9(smth9(smth9(QVAPOR.1))))'
'cbarn 1 1 10.0 4.5'
'set gxout vector'
len = 0.5
scale = 20
...
'q time'
x=subwrd(result,3)
'draw title qvapor 700hPa 'x''
'printim ./uv_qvapor/'tt'.png white x2000 y2000'
'c'
tt=tt+2
endwhile
