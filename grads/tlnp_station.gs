...
'set t 1'
'set lev 850 200'
'define wspd=wspd*2.5'
'define wdir=wdir'
'define tc=tc'
'define td=td'
plotskew(tc,td,wspd,wdir)
...
*
*---------------- Color Options ------------------------------------------
* new color must be larger than 100
"set rgb 100 160 32 240"
"set rgb 101 255 165 0"
"set rgb 102 0 100 0"
*
*
