...
'collect 1 gr2stn(rh*(0.62197*((6.1078*exp(17.27*(tk-273.16)/(tk-35.86))))/(pressure-(6.1078*exp(17.27*(tk-273.16)/(tk-35.86)))))/100.,'lon','lat')'
lon = lon + 0.02
endwhile
...
'draw title specific humidity 'time''
'printim ./q_v/q_'tt'.png x1000 y1000 white'
'c'
tt=tt+1
endwhile
;
